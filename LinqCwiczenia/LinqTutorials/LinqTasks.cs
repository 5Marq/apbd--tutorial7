...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<object> result = Emps.Select(emp => 
                    new
                    {
                        emp.Ename, 
                        emp.Job, 
        ...
        public static IEnumerable<Dept> Task14()
        {
            IEnumerable<Dept> result = Emps.GroupBy(emp => emp.Deptno)
                .Where(group => group.Count() == 0 || group.Count() == 5)
                .Select(group => Depts.FirstOrDefault(d => d.Deptno == group.Key))
